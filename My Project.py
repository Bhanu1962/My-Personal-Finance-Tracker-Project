...
from data_entry import get_amount,get_cateogry,get_date,get_descriptin
...
class CSV:
    ...
    def get_transactions(cls,start_date,end_date):
        ...
        if filtered_df.empty:
            ...
            print("Net Saving: ${(total_income - total_expense):.2f}")
...
def add():
    ...
    amount = get_amount()
    category =get_cateogry()
    description =get_descriptin()
